...
class DualHeaderWithHint extends StatelessWidget {
  DualHeaderWithHint({this.name, this.value, this.hint, this.showHint});
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: <Widget>[
        Container(
          margin:
              EdgeInsets.only(left: 24.0, right: 24.0, bottom: 24.0) - margin,
          child: Center(
        ...
        Container(
          ...
          child: Row(
            ...
            children: <Widget>[
              ...
              Container(
                margin: EdgeInsets.only(right: 8.0),
                child: FlatButton(onPressed: onSave, child: Text('Save')),
              )
            ],
          ),
        )
...
class ExpansionPanelsDemo extends StatefulWidget {
  ...
  @override
  ExpansionPanelsDemoState createState() => ExpansionPanelsDemoState();
}

class ExpansionPanelsDemoState extends State<ExpansionPanelsDemo> {
                  ...
                  child: FormField<double>(
                      ...
                      builder: (FormFieldState<double> field) {
                        return Slider(
                            ...
                            divisions: 5,
                            activeColor: Colors
                                .orange[100 + (field.value * 5.0).round()],
                            value: field.value,
                            onChanged: field.didChange);
                      }),
                );
