...
TextStyle abrilFatfaceRegular24(Color color) =>
    ShrineStyle.roboto(24.0, FontWeight.w500, color);

TextStyle abrilFatfaceRegular34(Color color) =>
    ShrineStyle.roboto(34.0, FontWeight.w500, color);
...
class ShrineTheme extends InheritedWidget {
  ...
  final Color dividerColor = Color(0xFFD9D9D9);
  final Color priceHighlightColor = Color(0xFFFFE0E0);
