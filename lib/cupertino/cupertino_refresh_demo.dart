...
class CupertinoRefreshControlDemo extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return CupertinoRefreshControlDemoState();
  }
}

class CupertinoRefreshControlDemoState
          ...
          child: CustomScrollView(
            slivers: <Widget>[
              CupertinoSliverNavigationBar(
                largeTitle: Text('Cupertino Refesh'),
                ...
                Expanded(
                  ...
                  children: <Widget>[
                    Text(
                      ...
                      style: TextStyle(
                          fontWeight: FontWeight.w600, letterSpacing: -0.18),
                    ),
                    Text(
                      place,
                      maxLines: 1,
